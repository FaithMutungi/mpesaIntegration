package com.Precious.Impl.controllers;

import com.Precious.Impl.dtos.*;
import com.Precious.Impl.repository.B2CC2BEntriesRepository;
import com.Precious.Impl.repository.StkPushEntriesRepository;
import com.Precious.Impl.services.DarajaApi;
...
public class MpesaController {
    ...
    public ResponseEntity<AcknowledgeResponse> mpesaValidation(@RequestBody MpesaValidationResponse mpesaValidationResponse) {
        ...
        B2CC2BEntries b2CC2BEntry = b2CC2BEntriesRepository.findByBillRefNumber(mpesaValidationResponse.getBillRefNumber());

        b2CC2BEntry.setRawCallbackPayloadResponse(String.valueOf(mpesaValidationResponse));
    ...
    public ResponseEntity<SimulateTransactionResponse> simulateB2CTransaction(@RequestBody SimulateTransactionRequest simulateTransactionRequest) {
        ...
        B2CC2BEntries b2C_c2BEntry = new B2CC2BEntries();
    ...
    public ResponseEntity<AcknowledgeResponse> b2cTransactionAsyncResults(@RequestBody B2CTransactionAsyncResponse b2CTransactionAsyncResponse)
        ...
        B2CC2BEntries b2cInternalRecord = b2CC2BEntriesRepository.findByConversationIdOrOriginatorConversationId(
                b2cResult.getConversationID(),
                b2cResult.getOriginatorConversationID());

        b2cInternalRecord.setRawCallbackPayloadResponse(String.valueOf(b2CTransactionAsyncResponse));
