...
import com.Precious.Impl.config.MpesaConfiguration;
import com.Precious.Impl.dtos.*;
import com.Precious.Impl.utils.Constants;
import com.Precious.Impl.utils.HelperUtility;
...
public class DarajaApiImpl implements DarajaApi {
    ...
    public AccessTokenResponse getAccessToken() {
        ...
        Request request = new Request.Builder()
                ...
                .get()
                .addHeader(Constants.AUTHORIZATION_HEADER_STRING, String.format("%s %s", Constants.BASIC_AUTH_STRING, encodedCredentials))
                .addHeader(Constants.CACHE_CONTROL_HEADER, Constants.CACHE_CONTROL_HEADER_VALUE)
                .build();
    ...
    public RegisterUrlResponse registerUrl() {
        ...
        Request request = new Request.Builder()
                ...
                .post(body)
                .addHeader("Authorization", String.format("%s %s", Constants.BEARER_AUTH_STRING, accessTokenResponse.getAccessToken()))
                .build();
    ...
    public SimulateTransactionResponse simulateC2BTransaction(SimulateTransactionRequest simulateTransactionRequest) {
        ...
        Request request = new Request.Builder()
                ...
                .post(body)
                .addHeader(Constants.AUTHORIZATION_HEADER_STRING, String.format("%s %s", Constants.BEARER_AUTH_STRING, accessTokenResponse.getAccessToken()))
                .build();
    ...
    public TransactionStatusSyncResponse getTransactionResult(InternalTransactionStatusRequest internalTransactionStatusRequest) {
        ...
        transactionStatusRequest.setCommandID(Constants.TRANSACTION_STATUS_QUERY_COMMAND);
        transactionStatusRequest.setPartyA(mpesaConfiguration.getShortCode());
        transactionStatusRequest.setIdentifierType(Constants.SHORT_CODE_IDENTIFIER);
        ...
        transactionStatusRequest.setRemarks(Constants.TRANSACTION_STATUS_VALUE);
        transactionStatusRequest.setOccasion(Constants.TRANSACTION_STATUS_VALUE);
